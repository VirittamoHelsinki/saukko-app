...
userRouter.post('/', async (req, res) => {
  ...
  try {
    ...
    if (newUserObject.role === 'customer') {
      // add customer's unique properties from the body to the user object
    }

    if (newUserObject.role === 'teacher') {
      // add teacher's unique properties from the body to the user object
    }

    if (newUserObject.role === 'supervisor') {
      // add supervisor's unique properties from the body to the user object
    }

    if (newUserObject.role === 'admin') {
      // add admin's unique properties from the body to the user object
    }
