...
//   // Set path & get degree units from InternalApiContext
...
//         // If successful, open the success NotificationModal
//         setOpenNotificationModal({ type: 'success', title: 'Uusi työpaikka lisätty' });
//       } else {
//         // If not successful, open the alert NotificationModal
...
//             <p className='second__paragraph'>{departments ? departments : ''}</p>
//           </div>
